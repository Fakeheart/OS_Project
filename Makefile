...
OBJS		= kernel/kernel.o lib/syscall.o kernel/start.o kernel/main.o\
			...
			kernel/kliba.o kernel/klib.o kernel/systask.o kernel/hd.o kernel/procmanage.o kernel/filemanage.o\
			lib/printf.o lib/bootanimation.o lib/vsprintf.o\
			lib/string.o lib/show.o lib/mkdir.o lib/misc.o lib/rename.o\
			lib/open.o lib/read.o lib/write.o lib/close.o lib/unlink.o\
			lib/getpid.o lib/syslog.o\
			lib/wait.o lib/exit.o lib/stat.o\
			lib/keyboradHIT.o lib/fork.o lib/vmop.o\
			mm/main.o mm/forkexit.o\
			fs/main.o fs/open.o fs/misc.o fs/read_write.o\
			fs/link.o\
			fs/disklog.o\
			vm/main.o vm/Tools.o
...
kernel/procmanage.o: kernel/procmanage.c
	$(CC) $(CFLAGS) -o $@ $<

kernel/filemanage.o: kernel/filemanage.c
	$(CC) $(CFLAGS) -o $@ $<
...
lib/bootanimation.o: lib/bootanimation.c
	$(CC) $(CFLAGS) -o $@ $<
...
vm/Tools.o: vm/Tools.c
	$(CC) $(CFLAGS) -o $@ $<

lib/vmop.o: lib/vmop.c
	$(CC) $(CFLAGS) -o $@ $<

lib/keyboradHIT.o: lib/keyboradHIT.c
	$(CC) $(CFLAGS) -o $@ $<
